...
export default function BlogPostCreate({ categories }) {
    ...
    return (
        <AuthenticatedLayout>
            <Head title="Tulis Artikel Blog | Admin Mandala" />
            ...
            <div className="max-w-4xl mx-auto space-y-8 pb-20">
                <div className="flex justify-between items-center border-b pb-6" style={{ borderColor: 'var(--border)' }}>
                    <div>
                        <h1 className="text-3xl font-black italic uppercase tracking-tighter" style={{ color: 'var(--text-primary)' }}>
                            Tulis <span className="text-[#38BDF8]">Artikel</span>
                        </h1>
                    </div>
                </div>
                ...
                <div className="bg-slate-800/10 p-6 sm:p-10 rounded-[2.5rem] border-2 shadow-2xl" style={{ borderColor: 'var(--border)', background: 'var(--bg-card)' }}>
                    <form onSubmit={submit} className="space-y-8" encType="multipart/form-data">
                        ...
                        <div className="space-y-2">
                            <label className="text-[10px] font-black uppercase tracking-widest text-purple-400">Thumbnail (Gambar Cover)</label>
                            <input
                                type="file"
                                accept="image/*"
                        ...
                        <div className="space-y-2">
                            ...
                            <textarea
                                ...
                                placeholder="Ringkasan atau teks penarik (opsional)..."
                            />
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <textarea
                                ...
                                placeholder="Ketik isi blog di sini (mendukung HTML tipis jika dirender raw di frontend, atau ganti dengan Rich Text Editor nanti)..."
                            />
                        ...
                        <div className="flex gap-4 pt-6 border-t" style={{ borderColor: 'var(--border)' }}>
                            ...
                            <button type="submit" disabled={processing} className="px-10 py-4 rounded-[1.5rem] bg-[#38BDF8] text-slate-900 font-black uppercase tracking-widest text-sm shadow-xl hover:scale-105 transition-all disabled:opacity-50 italic">
